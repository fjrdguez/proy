...
return $this->services['security.firewall.map.context.usuarios'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 2 => ${($_ = isset($this->services['security.authentication.listener.form.usuarios']) ? $this->services['security.authentication.listener.form.usuarios'] : $this->load(__DIR__.'/getSecurity_Authentication_Listener_Form_UsuariosService.php')) && false ?: '_'};
    yield 3 => ${($_ = isset($this->services['security.authentication.listener.anonymous.usuarios']) ? $this->services['security.authentication.listener.anonymous.usuarios'] : $this->load(__DIR__.'/getSecurity_Authentication_Listener_Anonymous_UsuariosService.php')) && false ?: '_'};
