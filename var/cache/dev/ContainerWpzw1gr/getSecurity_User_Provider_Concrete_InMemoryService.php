...
return $this->services['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(array('admin' => array('password' => '1234', 'roles' => array(0 => 'ROLE_ADMIN'))));
