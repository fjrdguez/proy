...
return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 1 => ${($_ = isset($this->services['security.context_listener.2']) ? $this->services['security.context_listener.2'] : $this->load(__DIR__.'/getSecurity_ContextListener_2Service.php')) && false ?: '_'};
