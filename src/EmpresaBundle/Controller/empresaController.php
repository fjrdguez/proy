...
class empresaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('@Empresa/empresa/index.html.twig', array(
            'empresas' => $empresas,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('@Empresa/empresa/new.html.twig', array(
            'empresa' => $empresa,
    ...
    public function showAction(empresa $empresa)
    {
        ...
        return $this->render('@Empresa/empresa/show.html.twig', array(
            'empresa' => $empresa,
    ...
    public function editAction(Request $request, empresa $empresa)
    {
        ...
        return $this->render('@Empresa/empresa/edit.html.twig', array(
            'empresa' => $empresa,
